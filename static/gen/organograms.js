(function() {
  ...
  viz.setActiveOrganogram = function(slug, title) {
    ...
    return d3.csv("/organograms/data/csv/" + slug + "-junior.csv", function(junior) {
      if (viz.activeOrganogram.slug === slug) {
  ...
  window.viz.organogram = (function() {
    ...
    organogram.prototype.hoverPersonOut = function(d, i) {
      window.clearTimeout(window.viz.organogram_hover_timeout);
      this.hovering = null;
      return window.viz.organogram_hover_timeout = window.setTimeout(((function(_this) {
        return function() {
    ...
    organogram.prototype.renderOrgChart = function(intro) {
      ...
      this.svg.selectAll('.person').attr('display', 'inline').transition().duration(duration).delay(ripple).attr('transform', (function(_this) {
        return function(d) {
          if (d.y === 0) {
    ...
    organogram.prototype.renderTreeMap = function(intro) {
      ...
      }).transition().duration(duration).delay(ripple).attr('transform', (function(_this) {
        return function(d) {
